...
#include "DD_DunDefAtlantis_structs.hpp"
...
// 0x010C (0x0E10 - 0x0D04)
class ADunDefKraken : public ADunDefBoss
{
public:
	float                                              TentacleBlendOutTime;                                     // 0x0D04(0x0004) (Edit)
	TArray<struct FTentacle>                           Tentacles;                                                // 0x0D08(0x000C) (Edit, NeedCtorLink)
	TArray<struct FTentacle>                           LeftTentacles;                                            // 0x0D14(0x000C) (NeedCtorLink)
	TArray<struct FTentacle>                           RightTentacles;                                           // 0x0D20(0x000C) (NeedCtorLink)
	struct FName                                       OpenMouthAnim;                                            // 0x0D2C(0x0008) (Edit)
	struct FName                                       CloseMouthAnim;                                           // 0x0D34(0x0008) (Edit)
	struct FName                                       WithDrawAnim;                                             // 0x0D3C(0x0008) (Edit)
	struct FName                                       ProjectileAttack_Left;                                    // 0x0D44(0x0008) (Edit)
	struct FName                                       ProjectileAttack_Right;                                   // 0x0D4C(0x0008) (Edit)
	struct FName                                       ProjectileAttack_Giant;                                   // 0x0D54(0x0008) (Edit)
	struct FName                                       ProjectileAttack_GiantSocket;                             // 0x0D5C(0x0008) (Edit)
	struct FName                                       BiteAttackAnim;                                           // 0x0D64(0x0008) (Edit)
	struct FName                                       BiteSocketName;                                           // 0x0D6C(0x0008) (Edit)
	struct FName                                       TentacleAttackName;                                       // 0x0D74(0x0008) (Edit)
	struct FName                                       InkSocketName;                                            // 0x0D7C(0x0008) (Edit)
	struct FName                                       InkAnimName;                                              // 0x0D84(0x0008) (Edit)
	struct FName                                       DashWindUpAnim;                                           // 0x0D8C(0x0008) (Edit)
	struct FName                                       CrystalSocketName;                                        // 0x0D94(0x0008) (Edit)
	float                                              MinimumAngleDotForCrystalHit;                             // 0x0D9C(0x0004) (Edit)
	float                                              TentacleProjectileAnimSpeed;                              // 0x0DA0(0x0004) (Edit)
	float                                              TentacleRegrowTime[0x4];                                  // 0x0DA4(0x0004) (Edit)
	float                                              PauseAfterAttackTime[0x4];                                // 0x0DB4(0x0004) (Edit)
	class ADunDefEmitterSpawnable*                     CrystalHurtEffectTemplate;                                // 0x0DC4(0x0004) (Edit)
	class ADunDefEmitterSpawnable*                     TentacleRetreatEffectTemplate;                            // 0x0DC8(0x0004) (Edit)
	class UParticleSystemComponent*                    FloatingEffect;                                           // 0x0DCC(0x0004) (Edit, ExportObject, Component, EditInline)
	struct FName                                       FloatingEffectSocket;                                     // 0x0DD0(0x0008) (Edit)
	class UStaticMeshComponent*                        CrystalMesh;                                              // 0x0DD8(0x0004) (Edit, ExportObject, Component, EditInline)
	TArray<class AActor*>                              LeftSwingHurtList;                                        // 0x0DDC(0x000C) (NeedCtorLink)
	TArray<class AActor*>                              RightSwingHurtList;                                       // 0x0DE8(0x000C) (NeedCtorLink)
	unsigned long                                      bMouthOpen : 1;                                           // 0x0DF4(0x0004) (Net)
	unsigned long                                      bIsCharging : 1;                                          // 0x0DF4(0x0004) (Net)
	unsigned long                                      bCheckForPawnEnchroachers : 1;                            // 0x0DF4(0x0004)
	class UAnimNode_MultiBlendPerBone*                 TentacleBlender;                                          // 0x0DF8(0x0004)
	class UAnimNodePlayCustomAnim*                     TentacleCustomAnimNode;                                   // 0x0DFC(0x0004)
	float                                              TimeOfDeath;                                              // 0x0E00(0x0004)
	float                                              DeathTranslation;                                         // 0x0E04(0x0004)
	float                                              DeathTranslationTime;                                     // 0x0E08(0x0004)
	float                                              LastTentactleTakeDamageTime;                              // 0x0E0C(0x0004) (Transient)
...
// 0x00E8 (0x0DB8 - 0x0CD0)
class ADunDefSharkMan : public ADunDefEnemy
{
public:
	struct FName                                       LeftFistSocketName;                                       // 0x0CD0(0x0008) (Edit)
	struct FName                                       RightFistSocketName;                                      // 0x0CD8(0x0008) (Edit)
	struct FName                                       LeftElbowSocketName;                                      // 0x0CE0(0x0008) (Edit)
	struct FName                                       RightElbowSocketName;                                     // 0x0CE8(0x0008) (Edit)
	struct FName                                       ChargeWindupAnimName;                                     // 0x0CF0(0x0008) (Edit)
	struct FName                                       ChargingAnimName;                                         // 0x0CF8(0x0008) (Edit)
	struct FName                                       HitWallAnimName;                                          // 0x0D00(0x0008) (Edit)
	struct FName                                       ChargeFailAnimName;                                       // 0x0D08(0x0008) (Edit)
	struct FName                                       ChargeAbortAnimName;                                      // 0x0D10(0x0008) (Edit)
	struct FName                                       DizzyAnimName;                                            // 0x0D18(0x0008) (Edit)
	float                                              ChargePushSize;                                           // 0x0D20(0x0004) (Edit)
	float                                              PawnPushBackSpeed;                                        // 0x0D24(0x0004) (Edit)
	float                                              TowerPushBackSpeed;                                       // 0x0D28(0x0004) (Edit)
	float                                              ChargingNetUpdateFrequency;                               // 0x0D2C(0x0004) (Edit)
	float                                              TowerCollideDamageMultiplier;                             // 0x0D30(0x0004) (Edit)
	float                                              PlayerCollideDamageMultiplier;                            // 0x0D34(0x0004) (Edit)
	float                                              ChanceForImmediatePoundTheGround;                         // 0x0D38(0x0004) (Edit)
	float                                              WindupTimeScale;                                          // 0x0D3C(0x0004) (Edit)
	TArray<class ADunDefPlayer*>                       ChargeHurtList;                                           // 0x0D40(0x000C) (NeedCtorLink)
	float                                              GroundPoundDamage;                                        // 0x0D4C(0x0004) (Edit)
	float                                              GroundPoundRadius;                                        // 0x0D50(0x0004) (Edit)
	class UClass*                                      GroundPoundDamageType;                                    // 0x0D54(0x0004) (Edit)
	float                                              ChargeAnimationSpeed;                                     // 0x0D58(0x0004) (Edit)
	class ADunDefEmitterSpawnable*                     GroundStrikeEffect;                                       // 0x0D5C(0x0004) (Edit)
	struct FVector                                     GroundStrikeEffectOffset;                                 // 0x0D60(0x000C) (Edit)
	float                                              GroundStrikeKnockback;                                    // 0x0D6C(0x0004) (Edit)
	float                                              TowerTargetingDesirability_Charging;                      // 0x0D70(0x0004) (Edit)
	float                                              TowerTargetingDesirability_WindUp;                        // 0x0D74(0x0004) (Edit)
	TArray<struct FName>                               UpperBodyCustomAnimNodeNames;                             // 0x0D78(0x000C) (Edit, NeedCtorLink)
	struct FName                                       UpperBodyCustomAnimBlenderName;                           // 0x0D84(0x0008) (Edit)
	TArray<float>                                      ChargeSpeeds;                                             // 0x0D8C(0x000C) (Edit, NeedCtorLink)
	class UAnimNodeBlend*                              UpperBodyCustomAnimBlender;                               // 0x0D98(0x0004)
	int                                                LastUpperBodyCustomAnimNodePlayIndex;                     // 0x0D9C(0x0004)
	struct FName                                       ArmBlenderName;                                           // 0x0DA0(0x0008) (Edit)
	class UAudioComponent*                             ScreamLoopSound;                                          // 0x0DA8(0x0004) (Edit, ExportObject, Component, EditInline)
	class UParticleSystemComponent*                    DashEffectComponent;                                      // 0x0DAC(0x0004) (Edit, ExportObject, Component, EditInline)
	class AActor*                                      ChargeTarget;                                             // 0x0DB0(0x0004) (Net)
	unsigned long                                      bWindingUp : 1;                                           // 0x0DB4(0x0004) (Net)
