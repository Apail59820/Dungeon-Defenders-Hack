...
#include "DD_DunDefSpider_structs.hpp"
...
// 0x004C (0x0D1C - 0x0CD0)
class ADunDefSpider : public ADunDefEnemy
{
public:
	struct FName                                       LungeAnimation;                                           // 0x0CD0(0x0008) (Edit)
	struct FName                                       WebShootAnimation;                                        // 0x0CD8(0x0008) (Edit)
	struct FName                                       WebChargeAnimation;                                       // 0x0CE0(0x0008) (Edit)
	struct FName                                       WebShootSocket;                                           // 0x0CE8(0x0008) (Edit)
	struct FName                                       MeleeSwingSocketName;                                     // 0x0CF0(0x0008) (Edit)
	struct FName                                       SpawnParticleMeshAttachmentSocket;                        // 0x0CF8(0x0008) (Edit)
	float                                              MaxWebParticleScale;                                      // 0x0D00(0x0004) (Edit)
	class UParticleSystemComponent*                    WebChargeParticleSystem;                                  // 0x0D04(0x0004) (Edit, ExportObject, Component, EditInline)
	class USoundCue*                                   WebChargeSound;                                           // 0x0D08(0x0004) (Edit)
	class UParticleSystemComponent*                    SpawnParticleEffect;                                      // 0x0D0C(0x0004) (Edit, ExportObject, Component, EditInline)
	unsigned long                                      bAttachSpawnParticleToMesh : 1;                           // 0x0D10(0x0004) (Edit)
	unsigned long                                      bUseSpawnEffect : 1;                                      // 0x0D10(0x0004) (Edit)
	unsigned long                                      bPlayingWebCharge : 1;                                    // 0x0D10(0x0004) (Net)
	unsigned long                                      bPlaySpawnEffect : 1;                                     // 0x0D10(0x0004) (Net)
	float                                              WebStartTime;                                             // 0x0D14(0x0004)
	float                                              WebChargeTime;                                            // 0x0D18(0x0004) (Net)
...
// 0x00D0 (0x0DD4 - 0x0D04)
class ADunDefSpiderQueen : public ADunDefBoss
{
public:
	float                                              StunDelay;                                                // 0x0D04(0x0004) (Edit)
	float                                              CoreDamageMultiplier;                                     // 0x0D08(0x0004) (Edit)
	float                                              MinimumAngleDotForSuperHit;                               // 0x0D0C(0x0004) (Edit)
	TArray<float>                                      NonStunnedDmgScalar;                                      // 0x0D10(0x000C) (Edit, NeedCtorLink)
	float                                              CurrentNonStunnedDmgScalar;                               // 0x0D1C(0x0004)
	float                                              BabySpawnPlayRate;                                        // 0x0D20(0x0004) (Edit)
	struct FName                                       BabySpawnLocSocket;                                       // 0x0D24(0x0008) (Edit)
	struct FName                                       BabySpawnAnimName;                                        // 0x0D2C(0x0008) (Edit)
	struct FName                                       StunnedAnimLoop;                                          // 0x0D34(0x0008) (Edit)
	struct FName                                       CrystalSocketName;                                        // 0x0D3C(0x0008) (Edit)
	struct FName                                       MeleeSwingSocketName;                                     // 0x0D44(0x0008) (Edit)
	struct FName                                       WebShootSocket;                                           // 0x0D4C(0x0008) (Edit)
	struct FName                                       WebShootAnimation;                                        // 0x0D54(0x0008) (Edit)
	struct FName                                       StunnedHurtAnim;                                          // 0x0D5C(0x0008) (Edit)
	class ADunDefEmitterSpawnable*                     StunnedHurtEffectTemplate;                                // 0x0D64(0x0004) (Edit)
	class UParticleSystemComponent*                    StunnedCoreVFX;                                           // 0x0D68(0x0004) (Edit, ExportObject, Component, EditInline)
	class UParticleSystemComponent*                    EnragedVFX;                                               // 0x0D6C(0x0004) (Edit, ExportObject, Component, EditInline)
	struct FName                                       EnrageSocketName;                                         // 0x0D70(0x0008) (Edit)
	struct FName                                       UpperBodyLookAtName;                                      // 0x0D78(0x0008) (Edit)
	float                                              CrystalScaleDownTime;                                     // 0x0D80(0x0004) (Edit)
	float                                              MinCrystalBrightnessScale;                                // 0x0D84(0x0004) (Edit)
	float                                              EnrageHealthPct;                                          // 0x0D88(0x0004) (Edit)
	float                                              EnrageDmgMult;                                            // 0x0D8C(0x0004) (Edit)
	float                                              EnrageBabySpawnMult;                                      // 0x0D90(0x0004) (Edit)
	float                                              EnrageIntervalMult;                                       // 0x0D94(0x0004) (Edit)
	float                                              EnrageGroundSpeedMult;                                    // 0x0D98(0x0004) (Edit)
	unsigned long                                      bRageMode : 1;                                            // 0x0D9C(0x0004)
	unsigned long                                      bIsStunned : 1;                                           // 0x0D9C(0x0004)
	unsigned long                                      bLookAtTarget : 1;                                        // 0x0D9C(0x0004)
	float                                              TimeOfDeath;                                              // 0x0DA0(0x0004)
	class UMaterialInstanceConstant*                   QueenMIC;                                                 // 0x0DA4(0x0004)
	class USkelControlLookAt*                          UpperBodyLookAt;                                          // 0x0DA8(0x0004)
	class USkelControlLookAt*                          IKTest;                                                   // 0x0DAC(0x0004)
	class AActor*                                      TheLastDamageCauser;                                      // 0x0DB0(0x0004)
	float                                              WebChargeTime;                                            // 0x0DB4(0x0004)
	float                                              WebStartTime;                                             // 0x0DB8(0x0004)
	float                                              currentTakenStunnedDamage;                                // 0x0DBC(0x0004)
	float                                              AllowedDmgStunnedPct;                                     // 0x0DC0(0x0004) (Edit)
	struct FLinearColor                                EnrageCoreColor;                                          // 0x0DC4(0x0010) (Edit)
