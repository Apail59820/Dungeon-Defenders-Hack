...
#include "DD_DunDefSkyCity_structs.hpp"
...
// 0x0034 (0x03A8 - 0x0374)
class ADunDefProjectile_Meteor : public ADunDefProjectile
{
public:
	class ADunDefEmitterSpawnable*                     DamagingFireEmitters;                                     // 0x0374(0x0004) (Edit)
	int                                                MaxNumberofFires;                                         // 0x0378(0x0004) (Edit)
	float                                              MinDecalSize;                                             // 0x037C(0x0004) (Edit)
	float                                              MaxDecalSize;                                             // 0x0380(0x0004) (Edit)
	float                                              MinDecalHeight;                                           // 0x0384(0x0004) (Edit)
	float                                              MaxDecalHeight;                                           // 0x0388(0x0004) (Edit)
	float                                              MinFireSpreadRadius;                                      // 0x038C(0x0004) (Edit)
	float                                              MaxFireSpreadRadius;                                      // 0x0390(0x0004) (Edit)
	float                                              decalZOffset;                                             // 0x0394(0x0004) (Edit)
	class ADecalActorMovableSpawnable*                 DecalActorTemplate;                                       // 0x0398(0x0004) (Edit)
	unsigned long                                      bUseShadow : 1;                                           // 0x039C(0x0004) (Edit)
	unsigned long                                      bUseHoming : 1;                                           // 0x039C(0x0004) (Edit)
	class UStaticMeshComponent*                        MyShadow;                                                 // 0x03A0(0x0004) (Edit, ExportObject, Component, EditInline)
	class ADecalActorMovableSpawnable*                 myDecal;                                                  // 0x03A4(0x0004) (Transient)
...
// 0x00DC (0x0DAC - 0x0CD0)
class ADunDefGoblinCopter : public ADunDefEnemy
{
public:
	TArray<struct FHoldAI>                             HoldableTemplates;                                        // 0x0CD0(0x000C) (Edit, NeedCtorLink)
	struct FName                                       DropOffAnimName;                                          // 0x0CDC(0x0008) (Edit)
	struct FName                                       ShootLeftAnimName;                                        // 0x0CE4(0x0008) (Edit)
	struct FName                                       ShootRightAnimName;                                       // 0x0CEC(0x0008) (Edit)
	struct FName                                       ShootDoubleAnimName;                                      // 0x0CF4(0x0008) (Edit)
	TArray<struct FName>                               SpawnInAnimName;                                          // 0x0CFC(0x000C) (Edit, NeedCtorLink)
	struct FName                                       ShootLeftSocketName;                                      // 0x0D08(0x0008) (Edit)
	struct FName                                       ShootRightSocketName;                                     // 0x0D10(0x0008) (Edit)
	float                                              DeathVelocityForce;                                       // 0x0D18(0x0004) (Edit)
	float                                              DeathSpinRotRate;                                         // 0x0D1C(0x0004) (Edit)
	float                                              MiniMapHoldOffset;                                        // 0x0D20(0x0004) (Edit)
	float                                              MiniMapHoldIconSize;                                      // 0x0D24(0x0004) (Edit)
	float                                              HeldMiniMapIconSize;                                      // 0x0D28(0x0004) (Net)
	TArray<class ADunDefEmitterSpawnable*>             DestructionEffects;                                       // 0x0D2C(0x000C) (Edit, NeedCtorLink)
	class ADunDefEmitterSpawnable*                     FlareTemplate;                                            // 0x0D38(0x0004) (Edit)
	struct FName                                       RightFlareSocketName;                                     // 0x0D3C(0x0008) (Edit)
	struct FName                                       LeftFlareSocketName;                                      // 0x0D44(0x0008) (Edit)
	float                                              FlareVelocity;                                            // 0x0D4C(0x0004) (Edit)
	float                                              FlareFallSpeed;                                           // 0x0D50(0x0004) (Edit)
	float                                              FlareLifeSpan;                                            // 0x0D54(0x0004) (Edit)
	float                                              FlareLifeSpanOffset;                                      // 0x0D58(0x0004) (Edit)
	struct FRotator                                    FlareRotOffset;                                           // 0x0D5C(0x000C) (Edit)
	TArray<struct FHeldPawnDifficultyOffset>           HeldPawnDifficultyOffsets;                                // 0x0D68(0x000C) (Edit, NeedCtorLink)
	TArray<class UClass*>                              IgnoreDmgTypesWithFlare;                                  // 0x0D74(0x000C) (Edit, NeedCtorLink)
	float                                              PctDmgtoDroppedPawnOnDrop;                                // 0x0D80(0x0004) (Edit)
	class ADunDefEmitterSpawnable*                     myCurrentFlare;                                           // 0x0D84(0x0004) (Transient)
	class ADunDefEnemy*                                currentHeldPawn;                                          // 0x0D88(0x0004) (Net)
	int                                                currentHeldIndex;                                         // 0x0D8C(0x0004) (Net)
	struct FVector                                     currentHoldOffset;                                        // 0x0D90(0x000C)
	unsigned long                                      bPawnUsedLocInterp : 1;                                   // 0x0D9C(0x0004) (Net)
	unsigned long                                      bPawnUsedClientRotInterp : 1;                             // 0x0D9C(0x0004) (Net)
	unsigned long                                      bStartFalling : 1;                                        // 0x0D9C(0x0004)
	unsigned long                                      bDamagePawnOnDrop : 1;                                    // 0x0D9C(0x0004)
	int                                                GCopterNumber;                                            // 0x0DA0(0x0004)
	float                                              CopterPushForce;                                          // 0x0DA4(0x0004)
	float                                              CopterProxDistance;                                       // 0x0DA8(0x0004)
