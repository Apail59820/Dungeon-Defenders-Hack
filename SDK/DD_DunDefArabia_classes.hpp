...
#include "DD_DunDefArabia_structs.hpp"
...
// 0x01A8 (0x0E78 - 0x0CD0)
class ADunDefDjinn : public ADunDefEnemy
{
public:
	class UParticleSystemComponent*                    FlyingParticleComponent;                                  // 0x0CD0(0x0004) (Edit, ExportObject, Component, EditInline)
	struct FName                                       FlyingParticleSocketName;                                 // 0x0CD4(0x0008) (Edit)
	struct FName                                       InterruptAnimName;                                        // 0x0CDC(0x0008) (Edit)
	class UMaterialInstanceConstant*                   GoldMaterialTemplate;                                     // 0x0CE4(0x0004) (Edit)
	class UParticleSystem*                             GoldParticleEffect;                                       // 0x0CE8(0x0004) (Edit)
	class ADunDefEmitterSpawnable*                     TowerDestroyTemplate;                                     // 0x0CEC(0x0004) (Edit)
	class ADunDefEmitterSpawnable*                     TowerDestroyTemplate_Ally;                                // 0x0CF0(0x0004) (Edit)
	class USoundCue*                                   TowerDestroySound;                                        // 0x0CF4(0x0004) (Edit)
	class ADunDefEmitterSpawnable*                     GoldEnemyConvertTemplate;                                 // 0x0CF8(0x0004) (Edit)
	class ADunDefEmitterSpawnable*                     GoldEnemyConvertTemplate_Ally;                            // 0x0CFC(0x0004) (Edit)
	struct FSpellAnims                                 GoldEnemyAnims;                                           // 0x0D00(0x003C) (Edit)
	class ADunDefEnemy*                                goldTarget;                                               // 0x0D3C(0x0004)
	class UParticleSystemComponent*                    AttachedVFXComponent;                                     // 0x0D40(0x0004) (ExportObject, Component, EditInline)
	struct FName                                       ProjectileSocketName;                                     // 0x0D44(0x0008) (Edit)
	class UAnimNodeSequence*                           SpellAnimNode;                                            // 0x0D4C(0x0004)
	class UAnimNodeBlend*                              SpellBlender;                                             // 0x0D50(0x0004)
	struct FSpellAnims                                 TowerDestructAnims;                                       // 0x0D54(0x003C) (Edit)
	class ADunDefTower*                                towerTarget;                                              // 0x0D90(0x0004)
	float                                              DeathScaleDownTime;                                       // 0x0D94(0x0004) (Edit)
	struct FName                                       GoldBeamSocketName;                                       // 0x0D98(0x0008) (Edit)
	struct FName                                       TowerBeamSocketName;                                      // 0x0DA0(0x0008) (Edit)
	class UParticleSystemComponent*                    BeamParticleComponent;                                    // 0x0DA8(0x0004) (ExportObject, Component, EditInline)
	class UParticleSystem*                             GoldBeamTemplate;                                         // 0x0DAC(0x0004) (Edit)
	class UParticleSystem*                             TowerBeamTemplate;                                        // 0x0DB0(0x0004) (Edit)
	class UParticleSystem*                             GoldBeamTemplate_Ally;                                    // 0x0DB4(0x0004) (Edit)
	class UParticleSystem*                             TowerBeamTemplate_Ally;                                   // 0x0DB8(0x0004) (Edit)
	class UParticleSystemComponent*                    CastingParticleComponent;                                 // 0x0DBC(0x0004) (ExportObject, Component, EditInline)
	float                                              MaxGlowColor;                                             // 0x0DC0(0x0004) (Edit)
	float                                              startTowerScaleValue;                                     // 0x0DC4(0x0004)
	float                                              currentGlowValue;                                         // 0x0DC8(0x0004)
	float                                              castStart;                                                // 0x0DCC(0x0004)
	float                                              scaleDownTime;                                            // 0x0DD0(0x0004) (Edit)
	float                                              initialTowerScale;                                        // 0x0DD4(0x0004)
	float                                              scaleStartTime;                                           // 0x0DD8(0x0004)
	unsigned long                                      bScaleDownTower : 1;                                      // 0x0DDC(0x0004)
	unsigned long                                      bIgnoreUpdatingTower : 1;                                 // 0x0DDC(0x0004)
	unsigned long                                      bReforming : 1;                                           // 0x0DDC(0x0004)
	float                                              CastTime;                                                 // 0x0DE0(0x0004) (Net)
	struct FLinearColor                                GlowColor;                                                // 0x0DE4(0x0010) (Edit)
	struct FName                                       GlowColorParamName_Squire;                                // 0x0DF4(0x0008) (Edit)
	struct FName                                       GlowColorParamName_Apprentice;                            // 0x0DFC(0x0008) (Edit)
	struct FLinearColor                                originalColor;                                            // 0x0E04(0x0010)
	float                                              MinTrapOpacity;                                           // 0x0E14(0x0004) (Edit)
	float                                              MinAuraScale;                                             // 0x0E18(0x0004) (Edit)
	TArray<struct FVector>                             DifficultyIdleColor;                                      // 0x0E1C(0x000C) (Edit, NeedCtorLink)
	int                                                djinnNumber;                                              // 0x0E28(0x0004)
	float                                              DjinnPushForce;                                           // 0x0E2C(0x0004)
	float                                              DjinnProxDistance;                                        // 0x0E30(0x0004)
	struct FColor                                      MiniMapPulseColor;                                        // 0x0E34(0x0004) (Edit)
	float                                              MiniMapPulseRate;                                         // 0x0E38(0x0004) (Edit)
	struct FName                                       EnterLampAnim;                                            // 0x0E3C(0x0008) (Edit)
	class ADunDefEmitterSpawnable*                     DirectionalLampVFX;                                       // 0x0E44(0x0004) (Edit)
	float                                              LampScaleDownTime;                                        // 0x0E48(0x0004) (Edit)
	class UMaterialInterface*                          AlliedMaterial;                                           // 0x0E4C(0x0004) (Edit)
	class UTexture2D*                                  AlliedIcon;                                               // 0x0E50(0x0004) (Edit)
	float                                              AllyDmgMultiplier;                                        // 0x0E54(0x0004) (Edit)
	float                                              TowerDmgMultiplier;                                       // 0x0E58(0x0004) (Edit)
	float                                              SpawnImmuneTime;                                          // 0x0E5C(0x0004) (Edit)
	float                                              MinUpDotForForcedMovement;                                // 0x0E60(0x0004) (Edit)
	float                                              TowerTargetingDesirability_Desummoning;                   // 0x0E64(0x0004) (Edit)
	float                                              LampScaleDownStartTime;                                   // 0x0E68(0x0004)
	class ADjinnLamp*                                  myLamp;                                                   // 0x0E6C(0x0004)
	class UMaterialInstanceConstant*                   DissolveMIC;                                              // 0x0E70(0x0004)
	class UAudioComponent*                             CastingSoundComponent;                                    // 0x0E74(0x0004) (ExportObject, Component, EditInline)
...
// 0x0158 (0x0E5C - 0x0D04)
class ADunDefGenieBoss : public ADunDefBoss
{
public:
	TArray<struct FEyeBeam>                            EyeBeamTypes;                                             // 0x0D04(0x000C) (Edit, NeedCtorLink)
	int                                                currentLeftEyeBeamIndex;                                  // 0x0D10(0x0004) (Net)
	int                                                currentRightEyeBeamIndex;                                 // 0x0D14(0x0004) (Net)
	struct FName                                       EyeAttack_Crazy;                                          // 0x0D18(0x0008) (Edit)
	struct FName                                       EyeAttack_Start;                                          // 0x0D20(0x0008) (Edit)
	struct FName                                       EyeAttack_Loop;                                           // 0x0D28(0x0008) (Edit)
	float                                              CrazyEyesTime;                                            // 0x0D30(0x0004) (Edit)
	float                                              LampVFXMagnitude;                                         // 0x0D34(0x0004) (Edit)
	class UParticleSystemComponent*                    HoverEffect;                                              // 0x0D38(0x0004) (Edit, ExportObject, Component, EditInline)
	struct FName                                       HoverSocketName;                                          // 0x0D3C(0x0008) (Edit)
	class ADunDefEmitterSpawnable*                     ImpactTemplate;                                           // 0x0D44(0x0004) (Edit)
	class ADunDefEmitterSpawnable*                     DirectionalLampVFX;                                       // 0x0D48(0x0004) (Edit)
	class ADunDefEmitterSpawnable*                     CrystalEmitter;                                           // 0x0D4C(0x0004) (Edit)
	class ADunDefEmitterSpawnable*                     currentLeftEyeImpactEmitter;                              // 0x0D50(0x0004)
	class ADunDefEmitterSpawnable*                     currentRightEyeImpactEmitter;                             // 0x0D54(0x0004)
	class UParticleSystemComponent*                    LeftEyeBeam;                                              // 0x0D58(0x0004) (Edit, ExportObject, Component, EditInline)
	class UParticleSystemComponent*                    RightEyeBeam;                                             // 0x0D5C(0x0004) (Edit, ExportObject, Component, EditInline)
	class UParticleSystemComponent*                    LeftEyeBeamStart;                                         // 0x0D60(0x0004) (Edit, ExportObject, Component, EditInline)
	class UParticleSystemComponent*                    RightEyeBeamStart;                                        // 0x0D64(0x0004) (Edit, ExportObject, Component, EditInline)
	class UParticleSystemComponent*                    RageEffect;                                               // 0x0D68(0x0004) (Edit, ExportObject, Component, EditInline)
	struct FName                                       RageEffectSocket;                                         // 0x0D6C(0x0008) (Edit)
	struct FName                                       LeftEyeSocketName;                                        // 0x0D74(0x0008) (Edit)
	struct FName                                       RightEyeSocketName;                                       // 0x0D7C(0x0008) (Edit)
	struct FName                                       BurpSocketName;                                           // 0x0D84(0x0008) (Edit)
	struct FName                                       BurpAnimName;                                             // 0x0D8C(0x0008) (Edit)
	struct FName                                       BiteAnim;                                                 // 0x0D94(0x0008) (Edit)
	struct FName                                       BiteSocket;                                               // 0x0D9C(0x0008) (Edit)
	struct FName                                       DjinSpawnAnimName;                                        // 0x0DA4(0x0008) (Edit)
	struct FName                                       LickAnimName;                                             // 0x0DAC(0x0008) (Edit)
	struct FName                                       LickAnimName_Super;                                       // 0x0DB4(0x0008) (Edit)
	struct FName                                       DeathLoopAnim;                                            // 0x0DBC(0x0008) (Edit)
	float                                              HeadInterpScalar;                                         // 0x0DC4(0x0004) (Edit)
	float                                              EyeSkelControlLoopAtInterpSpeed;                          // 0x0DC8(0x0004) (Edit)
	float                                              MaxLazerDistance;                                         // 0x0DCC(0x0004) (Edit)
	struct FName                                       DisappearAnimName;                                        // 0x0DD0(0x0008) (Edit)
	float                                              DissolveTime;                                             // 0x0DD8(0x0004) (Edit)
	float                                              DeathDissolveTime;                                        // 0x0DDC(0x0004) (Edit)
	float                                              HeadLookAtRotClamp;                                       // 0x0DE0(0x0004) (Edit)
	float                                              HeadLookAtInterpRate;                                     // 0x0DE4(0x0004) (Edit)
	float                                              HeadLookAtRotClamp_Crazy;                                 // 0x0DE8(0x0004) (Edit)
	float                                              HeadLookAtSinScale;                                       // 0x0DEC(0x0004) (Edit)
	float                                              HeadLookAtInterpRate_Crazy;                               // 0x0DF0(0x0004) (Edit)
	struct FColor                                      MiniMapPulseColor;                                        // 0x0DF4(0x0004) (Edit)
	float                                              MiniMapPulseRate;                                         // 0x0DF8(0x0004) (Edit)
	float                                              TowerDmgMultiplier;                                       // 0x0DFC(0x0004) (Edit)
	float                                              DissolveBegin;                                            // 0x0E00(0x0004)
	unsigned long                                      bAllowEyeTracking : 1;                                    // 0x0E04(0x0004) (Net)
	unsigned long                                      bStartEyeDamage : 1;                                      // 0x0E04(0x0004) (Net)
	unsigned long                                      bStartDissolve : 1;                                       // 0x0E04(0x0004)
	unsigned long                                      bReforming : 1;                                           // 0x0E04(0x0004)
	unsigned long                                      bForceIntoLamp : 1;                                       // 0x0E04(0x0004) (Net)
	unsigned long                                      bRageMode : 1;                                            // 0x0E04(0x0004) (Net)
	class USkelControlLookAt*                          RightEyeLookAt;                                           // 0x0E08(0x0004)
	class USkelControlLookAt*                          LeftEyeLookAt;                                            // 0x0E0C(0x0004)
	class USkelControlSingleBone*                      HeadLookAt;                                               // 0x0E10(0x0004)
	class UMaterialInstanceConstant*                   HeadMIC;                                                  // 0x0E14(0x0004)
	class UMaterialInstanceConstant*                   TongueMIC;                                                // 0x0E18(0x0004)
	class AActor*                                      LeftEyeTarget;                                            // 0x0E1C(0x0004) (Net)
	class AActor*                                      RightEyeTarget;                                           // 0x0E20(0x0004) (Net)
	class AActor*                                      HeadLookAtTarget;                                         // 0x0E24(0x0004) (Net)
	struct FVector                                     PreviousRightEyeLocation;                                 // 0x0E28(0x000C)
	struct FVector                                     PreviousLeftEyeLocation;                                  // 0x0E34(0x000C)
	float                                              LastValidRightEye;                                        // 0x0E40(0x0004)
	float                                              LastValidLeftEye;                                         // 0x0E44(0x0004)
	float                                              EyeResetTime;                                             // 0x0E48(0x0004)
	float                                              CrazyEyeTime;                                             // 0x0E4C(0x0004)
	class USoundCue*                                   GenieEnterLampSound;                                      // 0x0E50(0x0004) (Edit)
	class USoundCue*                                   GenieExitLampSound;                                       // 0x0E54(0x0004) (Edit)
	class UAudioComponent*                             EyeCastingSoundComponent;                                 // 0x0E58(0x0004) (Edit, ExportObject, Component, EditInline)
