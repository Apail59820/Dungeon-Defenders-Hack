...
public:
	...
	static uintptr_t								   ProcessEventFuncAddr;									 // 0x0000(0x0000)
	...
	inline void ProcessEvent(class UFunction* function, void* params)
	{
		...
		static Fn fn = reinterpret_cast<Fn>(ProcessEventFuncAddr);
	...
	bool STATIC_NotEqual_HighDigitIntHighDigitInt(const struct FHighDigitInt& A, const struct FHighDigitInt& B);
	bool STATIC_EqualEqual_HighDigitIntHighDigitInt(const struct FHighDigitInt& A, const struct FHighDigitInt& B);
	bool STATIC_GreaterEqual_HighDigitIntHighDigitInt(const struct FHighDigitInt& A, const struct FHighDigitInt& B);
	bool STATIC_LessEqual_HighDigitIntHighDigitInt(const struct FHighDigitInt& A, const struct FHighDigitInt& B);
	bool STATIC_Less_HighDigitIntHighDigitInt(const struct FHighDigitInt& A, const struct FHighDigitInt& B);
	bool STATIC_Greater_HighDigitIntHighDigitInt(const struct FHighDigitInt& A, const struct FHighDigitInt& B);
	...
	bool STATIC_LessEqual_HighDigitIntInt(const struct FHighDigitInt& A, int B);
	bool STATIC_GreaterEqual_IntHighDigitInt(int A, const struct FHighDigitInt& B);
	bool STATIC_GreaterEqual_HighDigitIntInt(const struct FHighDigitInt& A, int B);
	bool STATIC_LessEqual_IntHighDigitInt(int A, const struct FHighDigitInt& B);
	bool STATIC_Less_HighDigitIntInt(const struct FHighDigitInt& A, int B);
	bool STATIC_Greater_IntHighDigitInt(int A, const struct FHighDigitInt& B);
	bool STATIC_Greater_HighDigitIntInt(const struct FHighDigitInt& A, int B);
	bool STATIC_Less_IntHighDigitInt(int A, const struct FHighDigitInt& B);
	bool STATIC_NotEqual_IntHighDigitInt(int A, const struct FHighDigitInt& B);
	bool STATIC_NotEqual_HighDigitIntInt(const struct FHighDigitInt& A, int B);
	bool STATIC_EqualEqual_IntHighDigitInt(int A, const struct FHighDigitInt& B);
	bool STATIC_EqualEqual_HighDigitIntInt(const struct FHighDigitInt& A, int B);
	...
	bool IsTemplate();
	bool STATIC_IsDefaultObject(class UObject* anObject);
	class UObject* GetBaseArchetype();
	bool STATIC_IsInteger(float val);
	...
	struct FVector STATIC_ChooseVectorComponents(const struct FVector& V, bool includeX, bool includeY, bool includeZ);
	...
	float STATIC_FLerp(float Min, float Max, float Percent, bool ClampToMin, bool ClampToMax);
	...
	struct FColor STATIC_ColorScale(const struct FColor& col, float Scale, bool ScaleAlpha);
...
public:
	...
	struct FName                                       FriendlyName;                                             // 0x0000(0x0000) NOT AUTO-GENERATED PROPERTY
...
{
public:
	unsigned char                                      UnknownData00[0xF0];                                      // 0x0000(0x0000) NOT AUTO-GENERATED PROPERTY
